...
- `internal/runner` – `AgentRunner` interface plus Codex and Copilot runner adapters, prompt builder, runner config loader, and model-aware selector that orders runners by priority.
